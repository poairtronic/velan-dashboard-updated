...
export const normalizeError = async (error, fallbackMessage = 'An unexpected error occurred.') => {
  try {
    if (error instanceof Response) {
      ...
      switch (error.status) {
        case 400: return message !== fallbackMessage ? message : 'Invalid request. Please check your data.';
        case 401: return 'Session expired. Please log in again.';
        case 403: return 'You do not have permission to perform this action.';
        case 404: return 'The requested resource was not found.';
        case 429: return 'Too many requests. Please try again later.';
        case 500: return 'Something went wrong on our side. Please try again later.';
        case 502: return 'Bad gateway. Our servers are currently unreachable.';
        case 503: return 'Service unavailable. Please check back later.';
        case 504: return 'Gateway timeout. The request took too long.';
