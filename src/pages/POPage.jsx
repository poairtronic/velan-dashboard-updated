  ...
  useChart(
    leadsRef,
    {
      ...
      options: {
        ...
        scales: {
          x: {
            ticks: { color: '#7ba7cc', font: { size: 9 } },
            grid: { color: 'rgba(26,58,92,0.3)' },
          },
          y: {
            ticks: { color: '#7ba7cc' },
            grid: { color: 'rgba(26,58,92,0.3)' },
            title: { display: true, text: 'Days', color: '#7ba7cc' },
          },
        },
      },
    },
              ...
              {displayed.map((p, i) => {
                ...
                return (
                  <React.Fragment key={i}>
                    ...
                    >
                      <td className="mono text-accent fw7" style={{ fontSize: 13 }}>
                        {p.po}
                      </td>
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {delayedCount}{' '}
            <span style={{ fontSize: 11, color: 'var(--text-muted)' }}>({delayedPct}%)</span>
          </div>
        </div>
      </div>
            ...
            >
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <span
                    className={`status-pill ${scDone ? 'badge-green' : 'badge-yellow'}`}
                    style={{ fontSize: 8 }}
                  >
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          alignItems: 'center',
                          borderBottom:
                            idx < scItems.length - 1 ? '1px solid rgba(26,58,92,0.15)' : 'none',
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                          ...
                          <span
                            style={{
                              ...
                              fontWeight: 700,
                              fontSize: 12,
                              color: isItemDelayed ? 'var(--danger)' : 'var(--success)',
                            }}
                          >
